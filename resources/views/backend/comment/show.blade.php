...
<div class="main-panel">
	<div class="content">
		<div class="container-fluid">
			<h4 class="page-title">View Comment Page</h4>
			<div class="row">
				<div class="col-md-12">
					<div class="card">
				...
				<div class="col-md-12">
					...
					<div class="card">
						<div class="card-body">
							<p>{{ $comment->comment  }}</p>
							<p>By: {{ $comment->name }} | Email: {{ $comment->email }} | Date-Time: {{ date('d-m-Y h:i A', strtotime($comment->created_at)) }}</p>
						</div>
					</div>
				</div>
				<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							<p>{{ $reply->comment }}</p>
							<p>By: {{ $reply->user['name'] }} | Email: {{ $reply->user['email'] }} | Date-Time: {{ date('d-m-Y h:i A', strtotime($reply->created_at)) }}</p>
			...
			<div class="row">
				<div class="col-md-12">
					<h4 class="page-title">Added reply</h4>
					<div class="card">
						<div class="card-body">
