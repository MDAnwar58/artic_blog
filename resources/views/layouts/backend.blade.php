...
<head>
	...
	<!-- tags input -->
	<link rel="stylesheet" href="{{ asset('assets/backend/tag/bootstrap-tagsinput.css') }}">
...
<body>
		...
		<div class="main-header">
				...
				<div class="container-fluid">
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						<li class="nav-item dropdown">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="{{ url('assets/backend/img/profile.jpg') }}" alt="user-img" width="36" class="img-circle"><span >Hizrian</span></a>
							<ul class="dropdown-menu dropdown-user">
								<li>
									<div class="user-box">
										<div class="u-img"><img src="{{ url('assets/backend/img/profile.jpg') }}" alt="user"></div>
										<div class="u-text">
											<h4>Hizrian</h4>
			...
			<div class="sidebar">
				<div class="scrollbar-inner sidebar-wrapper">
					<div class="user">
						<div class="photo">
							<img src="{{ url('assets/backend/img/profile.jpg') }}">
						</div>
						<div class="info">
	...
	<!-- tags input -->
	<script src="{{ asset('assets/backend/tag/bootstrap-tagsinput.js') }}"></script>
